...
if(isset($_POST['key'])){
    ...
    foreach($chapterlist as $key => $chapter){
        ...
        $html .= '</h6><span><a class="vb-readview px-3" href="/read/book='.$bookKey.'" target="_blank"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a><button class="btn btn-danger vb-chapter-dlt" data-chapter="'.$key.'">Delete</button>';
