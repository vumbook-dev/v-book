...
if(isset($_COOKIE['userdata'])){
    ...
    $UFolder = "{$UName}{$UID}";
    if(isset($_POST['chapter']) && isset($_POST['title']) && isset($_POST['id']) && isset($_POST['file'])){
        ...
        foreach($contentlist as $key => $value){
            if($value->chapter == $chapter){
                ...
                $html .= '<li class="list-item-vbcontent d-flex justify-content-between align-items-center"><span class="vb-cnt-title" data-ch="'.$value->chapter.'" data-sctn="'.$key.'"><span class="editable-section pr-2 d-none d-inline"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>'.$value->cpart.'</span>
